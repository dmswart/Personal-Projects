(function($) {
    ...
    $.Point3D = function(a, b, c) {
        if (a instance of Point3D && b === undefined && c === undefined) {
            this.x = a.x;
            this.y = a.y;
            this.z = a.z;
    ...
    $.Point3D.prototype = {
        // chained arithmetic
        equals = function(other) {return new Point3D(this.x == other.x && this.y == other.y && this.z == other.z);},
        nequal = function(other) {return new Point3D(this.x != other.x || this.y != other.y || this.z != other.z);},
        negate = function() {return new Point3D(-this.x, -this.y, -this.z);},
        add = function(other) {return new Point3D(this.x + other.x, this.y + other.y);},
        sub = function(other) {return new Point3D(this.x - other.x, this.y - other.y);},
        mul = function(scalar) {return new Point3D(this.x * scale, this.y * scale);},
        div = function(scalar) {return new Point3D(this.x / val, this.y / val);}
        ...
        mercator = function() {
            var latitude = DMSCore.QUARTERTAU - this.phi();
    ...
    $.Point3D.fromMercator = function(pos) {
        ...
        return Point3D.fromSphericalCoords(1.0, DMSCore.QUARTERTAU - latitude, pos.x);
    }
